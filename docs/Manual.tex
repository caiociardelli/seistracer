...
\begin{itemize}
    ...
    \item \textbf{Python libraries}:
        \begin{itemize}
            \item NumPy>1.26.4: Data processing and arrays.
            \item SciPy>1.15.0: Interpolation (interp1d).
            \item Matplotlib>3.7.2: Plotting ray paths and models.
            \item PvPython>3.12.7: Python with Paraview bindings.
